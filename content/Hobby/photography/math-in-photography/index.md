...
快门速度约慢，曝光时间越长，光子累积量也就越多，照片越亮。具体公式将在下一节“曝光”中统一描述。
...
其中，$E$ 是单位面积曝光量；$I$ 是入射光照强度；$t$ 是曝光时间（快门）。显然，快门时间约长，接受到的光子数量就越多，也就越亮。
...
景深为前、后景深之差：$DoF = DoF_{\rm front} - DoF_{\rm rear}$
